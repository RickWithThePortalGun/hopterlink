  ...
  const ReportBusiness = ({ businessInfo }: Props) => {
    ...
    return (
        ...
        <CredenzaContent>
          <CredenzaHeader>
            <CredenzaTitle>
                Report {businessInfo.business_name}
            </CredenzaTitle>
            <CredenzaDescription className="text-center">
            Report {businessInfo?.business_name} and we'll let you know once the issue is resolved

            </CredenzaDescription>
          </CredenzaHeader>
          <CredenzaBody>
            <Textarea autoFocus className="text-[16px] h-52"   value={reportText}
