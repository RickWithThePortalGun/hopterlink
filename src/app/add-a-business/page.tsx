...
const validationSchema = z.object({
  email: z.string().min(1, "Email is required").email("Invalid email address").describe("Email"),
  business_name: z.string().min(1, "Business Name is required").describe("Business Name"),
  ...
  website: z.string().min(1, "Website is required").url("Invalid URL").describe("Website"),
  business_phone_1: z.string().min(1, "Primary Business Phone is required")
    .regex(/^[0-9]{10,15}$/, "Phone number is not valid")
    .describe("Primary Business Phone"),
  business_phone_2: z.string().regex(/^[0-9]{10,15}$/, "Phone number is not valid")
    .optional()
    .describe("Secondary Business Phone"),
  min_delivery_time_in_days: z.number().min(1, "Min Delivery Time is required").describe("Min Delivery Time"),
  max_delivery_time_in_days: z.number().min(1, "Max Delivery Time is required").describe("Max Delivery Time"),
  business_reg_no: z.string().optional().describe("Business Registration Number"),
...
const App = () => {
  ...
  useEffect(() => {
    if (selectedIndustry) {
      const industry = categories.find((category) => category.id.toString() === selectedIndustry);
    ...
    <div className="p-20 max-md:p-6 mt-20 min-w-full">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <div>
          ...
          {errors.email && <div className="w-full justify-end flex mt-2 text-xs text-primary">{errors.email.message}</div>}
        </div>

        <div>
          <Label>Business Name</Label>
          <Input {...register("business_name")} placeholder="Business Name" />
          {errors.business_name && <div className="w-full justify-end flex mt-2 text-xs text-primary">{errors.business_name.message}</div>}
        </div>

        <div>
          <Label>Description</Label>
          <Textarea {...register("description")} placeholder="Description" />
          {errors.description && <div className="w-full justify-end flex mt-2 text-xs text-primary">{errors.description.message}</div>}
        </div>

        <div>
          <Label>Location</Label>
          <Input {...register("location")} placeholder="Location" />
          {errors.location && <div className="w-full justify-end flex mt-2 text-xs text-primary">{errors.location.message}</div>}
        </div>
        ...
        <div>
          ...
          {errors.industry && <div className="w-full justify-end flex mt-2 text-xs text-primary">{errors.industry.message}</div>}
        </div>
        ...
        <div>
          ...
          {errors.industry_subcategory && (
           <div className="w-full justify-end flex mt-2 text-xs text-primary"> {errors.industry_subcategory.message}</div>
          )}
        </div>
        ...
        <div>
          ...
          {errors.website && <div className="w-full justify-end flex mt-2 text-xs text-primary"> {errors.website.message}</div>}
        </div>
        ...
        <div>
          ...
          {errors.business_phone_1 && (
            <div className="w-full justify-end flex mt-2 text-xs text-primary"> {errors.business_phone_1.message}</div>
          )}
        </div>
        ...
        <div>
          ...
          {errors.business_phone_2 && (
            <div className="w-full justify-end flex mt-2 text-xs text-primary"> {errors.business_phone_2.message}</div>
          )}
        </div>
        ...
        <div>
          ...
          {errors.min_delivery_time_in_days && (
            <div className="w-full justify-end flex mt-2 text-xs text-primary"> {errors.min_delivery_time_in_days.message}</div>
          )}
        </div>
        ...
        <div>
          ...
          {errors.max_delivery_time_in_days && (
            <div className="w-full justify-end flex mt-2 text-xs text-primary"> {errors.max_delivery_time_in_days.message}</div>
          )}
        </div>
        ...
        <div>
          ...
          {errors.business_reg_no && (
            <div className="w-full justify-end flex mt-2 text-xs text-primary"> {errors.business_reg_no.message}</div>
          )}
        </div>
        ...
        <div>
          ...
          {errors.acceptTerms && <div className="w-full justify-end flex mt-2 text-xs text-primary"> {errors.acceptTerms.message}</div>}
        </div>
