...
const Page = () => {
  ...
  const getUserinfo = async () => {
    ...
    if (!session?.access_token) {
      throw new Error(
        'User not authenticated or access token not found'
      )
    }
            ...
            <div className="flex flex-col gap-2">
              <Card className="p-4 h-fit flex justify-between flex-col">
                ...
                <p className="mt-4">
                  ...
                  adipisicing elit. Delectus, quae quaerat.
                  Sed ad, impedit maiores nobis aperiam vero
                  obcaecati blanditiis adipisci architecto
                  recusandae hic ab odio corporis, esse
                  cumque velit.
                </p>
              </Card>
            </div>
